    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative overflow-hidden border-b border-border">
        ...
        <div className="relative max-w-7xl mx-auto px-6 pt-28 pb-12 md:pt-32 md:pb-16">
          <p className="text-sm font-semibold text-primary uppercase tracking-widest mb-3">Resources</p>
          ...
          {primaryResources.map((resource) => {
            ...
            return (
              <Link
                key={resource.title}
                href={resource.href}
                className="group relative flex flex-col rounded-2xl border border-border bg-card p-7 transition-all duration-300 hover:border-primary/20 hover:shadow-lg hover:shadow-foreground/[0.03] hover:-translate-y-0.5"
              >
