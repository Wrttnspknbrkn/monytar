...
export default function GDPRPage() {
  return (
    <LegalPage title="GDPR Compliance" lastUpdated="February 1, 2026">
      ...
      <p>Monytar is committed to protecting the privacy and rights of individuals in the European Economic Area (EEA). We comply with the General Data Protection Regulation (GDPR) and provide tools to help your organization meet its own GDPR obligations.</p>

      <h2>Data Processing</h2>
      <p>Monytar acts as a data processor on behalf of your organization (the data controller). We process personal data only as instructed by your organization and in accordance with our Data Processing Agreement (DPA).</p>
      ...
      <p>Our designated Data Protection Officer can be reached at dpo@monytar.com for any GDPR-related inquiries, data subject access requests, or concerns about how we handle personal data.</p>
